...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.data.networking.addThingApi.impl)
            implementation(projects.data.networking.profileApi.api)
            implementation(projects.data.networking.profileApi.impl)
            ...
            implementation(projects.featureModules.addThing.data)
            implementation(projects.featureModules.addThing.domain.api)
            implementation(projects.featureModules.addThing.domain.impl)
            implementation(projects.featureModules.profile.data)
            implementation(projects.featureModules.profile.domain.api)
            implementation(projects.featureModules.profile.domain.impl)
